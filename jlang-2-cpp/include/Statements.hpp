...
namespace jlang {
    namespace statements {
        struct Statement {
            ...
            public:
            Statement() = default;
            Statement(Location loc, ExprType type, StatementType kind, std::shared_ptr<jlang::CompilerState> parser) : loc(loc), type(type), kind(kind), parser(parser) {}
            ...
            virtual std::string to_string() const {
                throw std::runtime_error("String conversion not implemented for this statement");
            }
        ...
        struct BlockStmt :public Statement {
            ...
            public:
            BlockStmt(Location loc, ExprType type, std::shared_ptr<jlang::CompilerState> parser, std::vector<Statement*> statements) : Statement(loc, type, StatementType::BLOCK, parser), statements(statements) {}
            BlockStmt(Location loc, ExprType type, StatementType kind, std::shared_ptr<jlang::CompilerState> parser, std::vector<Statement*> statements) : Statement(loc, type, kind, parser), statements(statements) {}
            BlockStmt() = default;
        ...
        struct LiteralStmt : public Statement{
            ...
            public:
            LiteralStmt(Location loc, ExprType type, std::shared_ptr<jlang::CompilerState> parser, std::string value) : Statement(loc, type, StatementType::LITERAL, parser), value(value) {}
            LiteralStmt(Location loc, ExprType type, std::shared_ptr<jlang::CompilerState> parser, std::uint64_t value) : Statement(loc, type, StatementType::LITERAL, parser), value(value) {}
            LiteralStmt() = default;
        };
        ...
        struct IdentStmt : public Statement{
            ...
            public:
            IdentStmt(Location loc, ExprType type, std::shared_ptr<jlang::CompilerState> parser, IdentType ident_kind, std::variant<Variable, Constant, FunProto> target, Statement *param = nullptr) : Statement(loc, type, StatementType::IDENT, parser), ident_kind(ident_kind), target(target), param(param) {}
        ...
        struct FunStmt : public Statement {
            ...
            BlockStmt *body;
            public:
            FunStmt(Location loc, std::shared_ptr<jlang::CompilerState> parser, FunProto &proto, BlockStmt *body) : Statement(loc, proto.get_return_type(), StatementType::FUNCTION, parser), proto(proto), body(body) {}   
            ~FunStmt() override {
                delete this->body;
            }
        };
        ...
        struct FunCallStmt : public Statement{
            ...
            Statement *args;
            public:
            FunCallStmt(Location loc, ExprType type, std::shared_ptr<jlang::CompilerState> parser, FunProto &proto, Statement *args) : Statement(loc, type, StatementType::FUNCALL, parser), proto(proto), args(args) {}
        };
        ...
        struct IntrinsicStmt : public Statement {
            ...
            Statement *args;
            public:
            IntrinsicStmt(Location loc, ExprType type, std::shared_ptr<jlang::CompilerState> parser, Intrinsic intrinsic_kind, Statement *args) : Statement(loc, type, StatementType::INTRINSIC, parser), intrinsic_kind(intrinsic_kind), args(args) {}
            const Intrinsic get_intrinsic_kind() const {return this->intrinsic_kind;}
            ~IntrinsicStmt () override {
                delete this->args;
            }
        };
        ...
        struct ControlStmt : public Statement {
            ...
            std::vector<Statement*> statements;
            public:
            ControlStmt(Location loc, ExprType type, std::shared_ptr<jlang::CompilerState> parser, ControlType control_kind, Statement *condition, std::vector<Statement *> statements) : Statement(loc, type, StatementType::CONTROL, parser), control_kind(control_kind), condition(condition), statements(statements) {}
        ...
        struct BinaryStmt : public Statement {
            ...
            Statement *right;
            public:
            BinaryStmt(Location loc, ExprType type, std::shared_ptr<jlang::CompilerState> parser, Operator op, Statement *left, Statement *right) : Statement(loc, type, StatementType::BINARY, parser), op(op), left(left), right(right) {}
            ~BinaryStmt() override {
                delete this->left;
                delete this->right;
            }
