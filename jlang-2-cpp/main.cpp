...
int main(int argc, char **argv) {
  ...
  auto intexpr1 =
  std::make_unique<jlang::statements::IntLiteralExpr>(token.location, 68); auto
  intexpr2 =
  std::make_unique<jlang::statements::IntLiteralExpr>(token.location, 1); auto
  binaryexpr = std::make_unique<jlang::statements::BinaryExpr>(token.location,
  ...
  auto calltarget =
  std::make_unique<jlang::statements::IntLiteralExpr>(token.location, 1); auto
  callexpr = new jlang::statements::SyscallExpr(token.location,
  std::move(calltarget), std::move(args));
