    ...
    while (line.length() > char_pos && !newline) {
      ...
      if (isalpha(line[char_pos])) {
        ...
        if (get_keyword_by_name(upper_word.c_str()) != Keyword::INVALID) {
          ...
          this->tokens.push_back(
              Token(TokenType::INTRINSIC, word,
                    Location(this->in_file_path, line_pos, column_pos),
          ...
          if (err_pos != std::string::npos) {
            ...
            this->tokens.push_back(Token(
                ...
                Location(this->in_file_path, line_pos, column_pos), word));
          }
        }
        ...
        if (string_value.success) {
          this->tokens.push_back(
              Token(TokenType::STRING_LITERAL, string_value.value,
                    Location(this->in_file_path, line_pos, column_pos),
